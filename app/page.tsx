...
const T=[{"i": "\ud83d\udcb0", "l": "Valuation", "d": "Holiday collectible values", "h": "/value"}, {"i": "\ud83d\udccb", "l": "Inventory", "d": "Collection tracking", "h": "/inventory"}, {"i": "\ud83c\udf81", "l": "Gift Guide", "d": "Holiday gift recs", "h": "/gifts"}, {"i": "\u270d\ufe0f", "l": "Listing Writer", "d": "Marketplace listings", "h": "/listing"}];
export default function P() {
  ...
  return (<div style={{minHeight:"100vh",background:"#040912",color:"#e2e8f0",fontFamily:"system-ui"}}>
    ...
    <section style={{background:"linear-gradient(135deg,#1E3A5F,#040912)",padding:"48px 24px 40px",textAlign:"center"}}>
      <h1 style={{fontSize:"clamp(22px,4vw,42px)",fontWeight:900,color:"#fff",margin:"0 0 10px",lineHeight:1.05}}>Christmas Chest<br/><span style={{color:"#FF0800"}}>Holiday Collectibles</span></h1>
